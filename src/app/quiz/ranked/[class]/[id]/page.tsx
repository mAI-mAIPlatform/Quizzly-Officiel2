...
export default function RankedQuizPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4">
      <div className="mb-10 flex justify-between items-center bg-primary/5 p-6 rounded-3xl border border-primary/10">
         <div>
         ...
         <div className="text-right">
            <div className="text-2xl font-black text-primary">{progress.rankedRank}</div>
            <div className="text-[9px] font-bold opacity-40 uppercase tracking-widest">Ton Rang</div>
         </div>
      </div>

      <div className="glass p-10 min-h-[600px] border-primary/20 shadow-2xl relative overflow-hidden">
        <QuizEngine 
          quiz={quiz} 
          backUrl="/classe" 
          matiereId="ranked"
