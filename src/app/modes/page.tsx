...
const modes = [
  ...
  },
  {
    id: "visuel",
    title: "MODE VISUEL",
    description: "Analyse des images, graphiques et résous des mystères géométriques.",
    icon: "👁️",
    ...
    <div className="max-w-6xl mx-auto space-y-12 animate-in fade-in duration-700 pb-20">
      <header className="text-center space-y-4">
        ...
        <p className="opacity-70 font-black uppercase tracking-[0.3em] text-xs max-w-lg mx-auto leading-relaxed">
          Choisis ton arène et montre ce que tu as dans le ventre.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {modes.map((mode, i) => (
          ...
          >
            <Link href={mode.link} className="block">
              <div className="glass p-8 h-full flex flex-col gap-6 border-primary/5 hover:border-primary/20 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5 relative overflow-hidden rounded-[3xl]">
                {/* Background Decor */}
                <div className={`absolute top-0 right-0 w-48 h-48 bg-gradient-to-br ${mode.color} opacity-5 -mr-24 -mt-24 rounded-full transition-transform group-hover:scale-150 duration-700`}></div>
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-sm font-medium opacity-60 leading-relaxed group-hover:opacity-80 transition-opacity">
                    {mode.description}
                  </p>
                </div>

                <div className="mt-auto relative z-10">
                  <div className={`inline-flex items-center gap-2 font-black text-[10px] uppercase tracking-widest text-primary group-hover:translate-x-2 transition-transform`}>
