    ...
    <div className="flex flex-col gap-8 w-full h-full text-foreground relative z-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <Link href="/matiere/Maths-6eme" className="glass p-6 group hover:border-primary/60 transition-colors duration-500 cursor-pointer relative overflow-hidden block">
