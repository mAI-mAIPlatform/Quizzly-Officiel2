    ...
    <div className="max-w-4xl mx-auto space-y-12 animate-in fade-in duration-700 pb-20">
      ...
      {weekendQuest && (
        <section className="space-y-6">
          ...
          <QuestCard quest={weekendQuest} isWeekend={true} claimQuestReward={claimQuestReward} claimChest={claimChest} />
        </section>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <section className="space-y-6">
          ...
          <div className="flex flex-col gap-4">
            {dailyQuests.map(q => <QuestCard key={q.id} quest={q} claimQuestReward={claimQuestReward} claimChest={claimChest} />)}
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="flex flex-col gap-4">
            {weeklyQuests.map(q => <QuestCard key={q.id} quest={q} claimQuestReward={claimQuestReward} claimChest={claimChest} />)}
          </div>
        </section>
      </div>
